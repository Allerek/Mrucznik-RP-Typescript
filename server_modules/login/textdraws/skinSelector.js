...
function initSkinSelectorTXD() {
    ...
    console.log(SkinSelector['select']);
...
OnPlayerClickTextDraw((player, txd) => {
    if (txd == SkinSelector['left']) {
        ...
        const sex = Players[player.playerid].sex;
        const age = Players[player.playerid].age;
        const origin = Players[player.playerid].origin;
        const currentSkin = Skins[sex][Players[player.playerid].skinSelectorSkin];
        Players[player.playerid].skin = currentSkin;
